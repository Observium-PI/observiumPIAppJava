...
public static void resgatar () throws Exception {
        ...
        String totalTxt = disk.totalDisco().toString();
        String atualTxt = disk.disponivelDisco().toString();
        ...
        uso = atualDouble * 100 / totalDouble;
    ...
    public static void validaAlerta(String tipoComponente, Double uso) throws Exception {
        try {
            ...
            if (uso >= 65 && uso <= 75) {
                ...
                nivelAlerta = "alto";
                txtReforco = "uma necessidade de atenção maior!";
                enviarAlerta(txtReforco, tipoAlerta, nivelAlerta, tipoComponente, uso, hostname);
            } else if (uso > 85) {
                nivelAlerta = "crítico";
