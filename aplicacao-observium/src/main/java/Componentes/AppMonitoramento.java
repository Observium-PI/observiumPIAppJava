...
public class AppMonitoramento {
    public void aplicacao() throws UnknownHostException, SocketException, Exception {
        ...
        Integer idComputador = maquina.buscarIdComputadorLocal(hostname);
        ...
        Monitoramento monitoramento = new Monitoramento(usoProcessador, usoMemoria, 
                usoDisco, dataHora, idComputador);
        monitorar.incluirMonitoramentoLocal(monitoramento);
